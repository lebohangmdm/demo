  ...
  return (
    ...
    >
      <Button
        ...
        className="relative hover:bg-transparent nav-link hover:text-blue-500 dark:bg-dark-background"
      >
        Company <ChevronDown />
      </Button>
      ...
      {isOpen && (
        <ul
          className={`absolute bg-white flex flex-col gap-2.5 w-[250px] dark:bg-dark-background  p-4  shadow-lg 
